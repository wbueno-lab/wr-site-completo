-- Create a default admin user (this will only work if there's a user with this email in auth.users)
-- The user will need to sign up first, then this will make them admin
