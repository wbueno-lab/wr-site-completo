...
import { Search, Filter, Grid, List, ChevronDown, X, Zap } from "lucide-react";
...
const JaquetasPage = () => {
  ...
  const filteredProducts = useMemo(() => {
    let filtered = jaquetasProducts.filter(product => product.is_active !== false);
    ...
    return filtered;
  }, [jaquetasProducts, searchQuery, selectedCategory, selectedBrands, priceRange, showNewOnly, showPromoOnly]);
  ...
  // Get unique categories from jaquetas products
  const jaquetasCategories = useMemo(() => {
    const categorySet = new Set<string>();
    jaquetasProducts.forEach(product => {
      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-muted-foreground">Carregando jaquetas...</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            <Zap className="h-8 w-8 text-accent-neon" />
            <h1 className="text-3xl font-bold">Jaquetas Motociclísticas</h1>
          </div>
          <p className="text-muted-foreground">
            Jaquetas de couro, têxtil e impermeáveis para todas as modalidades de motociclismo.
          </p>
        </div>
                  ...
                  <CardContent>
                    <Select value={selectedCategory} onValueChange={setSelectedCategory}>
                      ...
                      <SelectContent>
                        ...
                        {jaquetasCategories.map((category) => (
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
              <div>
                <p className="text-sm text-muted-foreground">
                  {sortedProducts.length} {sortedProducts.length === 1 ? 'jaqueta encontrada' : 'jaquetas encontradas'}
                </p>
              </div>
            ...
            {sortedProducts.length === 0 ? (
              <div className="text-center py-12">
                <Zap className="h-24 w-24 text-muted-foreground/50 mx-auto mb-4" />
                <h3 className="text-xl font-semibold mb-2">Nenhuma jaqueta encontrada</h3>
